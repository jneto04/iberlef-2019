...
def main():
   ...
   parser.add_argument('--test', type=str, default="2",
     help="Which test for Task 3 is being evaluated (1 or 2, default=2).")
   parser.add_argument('--golden', type=str, default="./IberLEFTask3-Test2.gold.tsv",
     help="Path to the tsv with the golden standard for the task.")
   parser.add_argument('--output', type=str, default="./IberLEFTask3Test2Result.csv",
   ...
   if FLAGS.aux !="":
      for filename in FLAGS.aux.split(","):
         if filename!="":
            ...
            while Relation(("ARGUMENT_1","ARGUMENT_1_CATEGORY1"),"RELATION",("ARGUMENT_2","ARGUMENT_2_CATEGORY")) in fRel:
               fRel.remove(Relation(("ARGUMENT_1","ARGUMENT_1_CATEGORY1"),"RELATION",("ARGUMENT_2","ARGUMENT_2_CATEGORY")))
            aux.extend(fRel)
   ...
   for filename in os.listdir(FLAGS.input):
      ...
      while ["SENTENCE_ID","RELATION_ID","SENTENCE","ARGUMENT_1","ARGUMENT_1_CATEGORY1","RELATION","ARGUMENT_2","ARGUMENT_2_CATEGORY"] in sysRelations:
        sysRelations.remove(["SENTENCE_ID","RELATION_ID","SENTENCE","ARGUMENT_1","ARGUMENT_1_CATEGORY1","RELATION","ARGUMENT_2","ARGUMENT_2_CATEGORY"])
      try:
